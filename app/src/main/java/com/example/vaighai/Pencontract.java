...
public class Pencontract extends Activity implements OnClickListener {
	@SuppressLint("NewApi")
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		String result = null;				
			...
			try
			{
				...
				String surl = "http://110.234.155.156:8080/Android/Pendingcatcontract.php";
		    		   ...
		    		   JSONObject Json = jArray.getJSONObject(j);    		 
		    				   for (int k = 0; k < 5; k++) {    					   
		    	    	         ...
		    	    	         if (k==0)											
		    	    	         {
		    	    	        	if(j==0) 
		    	    	        	{	    	    	        		
			    	    	           textView.setText(Json.getString("ITEMGRADE"));
	...
	public void onClick(View v) {
		int i =(int) Math.ceil(v.getId()/5);
		  switch (i) {    
		    case 2:		    	
		    	 Intent It=new Intent(this,Pendingbran.class);		    	
		    	 startActivity(It); 	 
		        break;
		    case 3:		    	
		    	 Intent itdob=new Intent(this,Pendingdob.class);		    	
		    	 startActivity(itdob); 	 
		        break;
		    case 4:		    	
		    	 Intent itfeed=new Intent(this,Pendingfeed.class);		    	
		    	 startActivity(itfeed); 	 
		        break;
		    case 5:		    	
		    	 Intent itfi=new Intent(this,Pendingfi.class);		    	
		    	 startActivity(itfi); 	 
		        break;		        
		    case 6:		    	
		    	 Intent itoil=new Intent(this,Pendingoil.class);		    	
		    	 startActivity(itoil); 	 
		        break;
