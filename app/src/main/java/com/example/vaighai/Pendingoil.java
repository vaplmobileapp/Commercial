...
public class Pendingoil extends Activity implements OnClickListener {
	@Override
	protected void onCreate(Bundle savedInstanceState) {	
		super.onCreate(savedInstanceState);
		setContentView(R.layout.pendingoil);
		int id_Click=0;
		String result = null;				
		...
		try
		{
			...
			String surl = "http://110.234.155.156:8080/Android/Pendingcatoil.php";
