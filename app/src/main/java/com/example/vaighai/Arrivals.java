...
public class Arrivals extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {		
			...
			String result = null;
				...
				{				
					...
					String surl = "http://110.234.155.156:8080/Android/arrivals.php?var1="+s1+"&var2=sfgg";
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		  Toast.makeText(getApplicationContext(), R.id.item1, Toast.LENGTH_SHORT).show();		
	
	    switch(item.getItemId())
	    {
	    case R.id.item1 :
	    	String s2=(getIntent().getExtras().getString("sdate1"));	
	    	 Intent It=new Intent(this,Arrmoncat.class);	
