...
public class Wheatstock extends Activity {
	@Override
	protected void onCreate(Bundle savedInstanceState) {
			super.onCreate(savedInstanceState);
			setContentView(R.layout.wheatstock);
			...
			String result = null;				
				...
				try
				{
					...
					String surl = "http://110.234.155.156:8080/Android/Wheatstock.php?var1="+s1+"&var2=sfgg";
