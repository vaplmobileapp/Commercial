...
public class Pendingfi extends Activity implements OnClickListener {
	@Override
	protected void onCreate(Bundle savedInstanceState) {	
		int id_Click=0;
		super.onCreate(savedInstanceState);
		setContentView(R.layout.pendingfi);
		String result = null;				
		InputStream webs = null;
		try
		{
			HttpClient httpclient = new DefaultHttpClient();
			String surl = "http://110.234.155.156:8080/Android/Pendingcatfi.php";
