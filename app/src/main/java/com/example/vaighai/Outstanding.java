...
public class Outstanding extends Activity implements OnClickListener {
	@SuppressLint("NewApi")
	@Override
	protected void onCreate(Bundle savedInstanceState) {	
		...
		String result = null;
			...
			try
			{
				...
				String surl = "http://110.234.155.156:8080/Android/outstanding.php?var1="+s1+"&var2=sfgg";		
	...
	public void onClick(View v) {	
		...
		case 1:
			...
			Intent itdob = new Intent(this,Dobparty.class);
