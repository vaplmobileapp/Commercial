	...
	protected void onCreate(Bundle savedInstanceState) {	
		...
		String result = null;
			...
			{				
				...
				String surl = "http://110.234.155.156:8080/Android/Branprocess.php?var1="+s1+"&var2="+s2;
		    		   ...
		    		   JSONObject Json = jArray.getJSONObject(j);    		 
		    				   for (int k = 0; k < 5; k++) {    					   
		    	    	         ...
		    	    	         if (k==0)											
		    	    	         {
		    	    	        	 if(j==0)
		    	    	        	 {
		    	    	        		 textView.setText(Json.getString("DAT"));
		    	    	          ...
		    	    	          textView.setTextSize(16);
		    	    	        	...
		    	    	        	if(j==0)
		    	    	        	 {
		    	    	        		 textView.setText(Json.getString("feedingqty"));
				    	    	          textView.setTextColor(Color.BLACK );
				    	    	          textView.setTextSize(16);
				    	    	          textView.setTypeface(Typeface.DEFAULT_BOLD);
		    	    	        	 }
