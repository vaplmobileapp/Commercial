...
public class Arrmoncat extends Activity implements OnClickListener {
	@SuppressLint("NewApi")
	@Override
	protected void onCreate(Bundle savedInstanceState) {
			super.onCreate(savedInstanceState);
			int id_clik=0;
			setContentView(R.layout.arrcatmon);
			...
			String result = null;
				...
				{				
					...
					String surl = "http://110.234.155.156:8080/Android/Montharrivals.php?var1="+s1+"&var2=sfgg";
